...
<div id="test"></div>
<div class="container">
    <table id="dg" style="width:100%;height:529px" title="分店列表" data-options="
            rownumbers:true,
            singleSelect:false,
            autoRowHeight:true,
            pagination:false,
        ...
        <tr>
            ...
            <th field="name" width="16%">名字</th>
            <th field="tel" width="17%">固定电话</th>
            <th field="telmov" width="17%">移动电话</th>
            <th field="userid" width="17%">操作员名称</th>
            <th field="fexp" width="17%">分店备注</th>
        </tr>
        </thead>
    </table>
...
<script type="text/javascript">
    ...
    function tableData(form) {
        ...
        $.ajax({
            type: "POST", url: "/Shop/selectByAll", dataType: "json", data: data, success: function (json) {
                for (var i = 0; i < json.list.length; i++) {
                    var shop = json.list[i];
                    rows.push({
                        id: shop.id,
                        code: shop.code,
                        name: shop.name,
    ...
    function resetDg() {
        ...
        $("#dg").datagrid({
            onDblClickRow:function(rowIndex, rowData){
                ...
                //编辑本行资料
                showPage("修改分店信息","/Shop/updat?id="+rowData.id,1000,400,function(){
                    tableData();
                },true,false);
            }
        });
    ...
    //打开新增页面
    function addPage() {
        showPage("新增分店信息","/Shop/ad",1000,400,function(){
            tableData();
        },true,false);
    }
